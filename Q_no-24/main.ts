...
console.log("Equality test:", ("Sumaira Malik" as string) === "Sumaira Malik");

console.log("Inequality test:", ("Sumaira Malik" as string) !== "Malik Sumaira");
...
console.log("Inequality test:", (10 as number) !== 9); //Inequality test
